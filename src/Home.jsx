    ...
    <>
      <div className="TopCard">
        ...
        <p>
          ...
          dolorum quaerat magnam necessitatibus velit explicabo voluptatibus
          corporis placeat, aut aliquid.
        </p>

        <button>Read more</button>
      </div>

      {/* // for mid section class */}

      <div className="mid_clas">
        <h1>Classes</h1>
        <p>
      ...
      <div className="Card">
        <div>
          <img
            src="https://metapercept.com/images/training-certification/Basic-DITA%E2%80%93XML.jpg"
            alt="name"
          />

          <h1>BasicTechnicalWriting</h1>
          <p>
            This course focuses on understanding the basics of technical writing
            and developing technical writing skills. In this course you will
            learn techniques to analyze writing contexts which helps you to
            produce effective, clean, and reader-center documents efficiently.
          </p>
      ...
      <div className="footer">
        ...
        <p className='blue'>back Top Top</p>
      </div>
    </>
  );
};
